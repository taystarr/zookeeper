...
app.get('/api/animals/:id', (req, res) => {
    ...
    if (result) {
        ...
        // sends 404 if requested resource not found
        res.send(404);
    }
});
...
app.post('/api/animals', (req, res) => {
    ...
    // if any data in req.body is incorrect, send enrror
    if (!validateAnimal(req.body)) {
        res.status(400).send('Thats embarrassing. The animal is not properly formatted.');
    } else {
